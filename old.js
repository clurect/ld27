...
old.start = function() {
    ...
    make_text = function (sx,sy,x,y,t,op) {
     ...
     make_enemy = function (x,y, dx, dy) {
        return {
            body : new lime.Sprite().setSize(75,75).setPosition(x,y).setFill('assets/enemy.png'),
    ...
    var moves_in = false,
	    ...
	    character = new lime.Circle().setFill('assets/ninja.png').setSize(75, 75).setPosition(512, 384),
...
goog.exportSymbol('old  .start', old.start);
